...
@class LATNetInfo, LATNetError, LATNetUploadFileData;

typedef NS_ENUM(NSInteger, LATNetRequestMethodType) {
    LATNetRequestMethodTypeGET,
    LATNetRequestMethodTypePOST,
    LATNetRequestMethodTypeHEAD,
    LATNetRequestMethodTypePATCH,
    LATNetRequestMethodTypePUT,
    LATNetRequestMethodTypeDELETE
};
...
@interface LATNetRequestEnitity : NSObject
 ...
 *  HTTPHeaderFields
 */
@property (nullable, nonatomic, strong) NSDictionary *HTTPHeaderFields;
/**
 *
 *  请求成功的block
 */
